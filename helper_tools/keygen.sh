...
openssl req -new -key server.key -out server.csr -subj "/CN=clipshare_server"
...
openssl req -new -key client.key -out client.csr -subj "/CN=clipshare_client"
...
echo
echo "# the server's common name is clipshare_server"
echo "# the client's common name is clipshare_client"
echo
